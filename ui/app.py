...
class App(ctk.CTk):
    def __init__(self):
        ...
        ctk.set_appearance_mode("Light") # MUDANÇA PARA O TEMA CLARO
        
        # Define as cores principais da nossa marca
        self.APP_COLOR = "#1A3A7D" # Azul escuro da logo
        self.BG_COLOR = "#FFFFFF"   # Fundo branco

        # Carrega os dados e analisadores
        ...
        # Configura o estilo da Tabela (TreeView) para o tema claro
        style = ttk.Style()
    ...
    def create_header(self):
        ...
        self.start_date_entry = ctk.CTkEntry(header_frame, placeholder_text="YYYY-MM-DD")
        self.start_date_entry.pack(side="left", padx=5)
        self.start_date_entry.insert(0, "2024-01-01")

        ctk.CTkLabel(header_frame, text="até").pack(side="left", padx=5)
        self.end_date_entry = ctk.CTkEntry(header_frame, placeholder_text="YYYY-MM-DD")
